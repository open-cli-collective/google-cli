...
Examples:
  mail categorize promotions msg123
  mail categorize social --query "from:linkedin"
  mail categorize promotions --query "category:updates from:noreply" --dry-run`, strings.Join(validCategories, ", ")),
