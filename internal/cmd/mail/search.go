...
Examples:
  mail search "from:alice@example.com"
  mail search "subject:meeting" --max 20
  mail search "is:unread"
  mail search "after:2024/01/01 before:2024/02/01"
  mail search "is:inbox" --ids | mail archive --stdin
