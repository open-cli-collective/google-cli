...
Examples:
  mail draft --to alice@example.com --subject "Hi" --body "**hello**"
  mail draft --to "a@x.com, b@x.com" --subject "Sync" --file notes.md
  echo "# Hello" | mail draft --to a@x.com --subject "Hi" --stdin
  mail draft --to a@x.com --subject "Plain" --body "no md" --plain
  mail draft --to a@x.com --subject "Report" --body "see attached" --attach report.pdf
  mail draft --reply-to <message-id> --body "thanks, will review"
  mail draft --reply-to <message-id>            # quote-only reply
  mail draft --reply-to <message-id> --no-quote --body "ack"
  mail draft --reply-to <message-id> --reply-all --body "..."`,
